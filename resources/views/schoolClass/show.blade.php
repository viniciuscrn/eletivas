...
@section('content')
    ...
    <form class="row g-3" action="{{ route('student.store') }}" method="post">
        ...
        <div class="col-md-5">
            ...
            <input type="text" class="form-control md-4" name="name" required id="name" placeholder="Informe o nome do Aluno">
        </div>
        <div class="col-auto">
            <label for="registration" class="visually-hidden">Matrícula</label>
            <input type="text" class="form-control" name="registration" required id="registration" placeholder="Informe a matrícula">
        </div>
        <div class="col-auto">
            ...
            <tbody>
                ...
                @foreach ($schoolClass->students as $item)
                    <tr>
                        ...
                        <td class="text-center"><a href="{{ route('student.edit', ['id' => $item->id]) }}">Editar</a></td>
                    </tr>
                    @php $cont ++; @endphp
                @endforeach
            </tbody>
